...
public class ThirdRatings {
    ...
    private static final String DATA_PATH =
        "/Users/cerengunhan/Desktop/Duke-Java-Course/Lesson/RecommendationProject3/data/";
    ...
    public ThirdRatings(String ratingsfile) {
        myRaters =
            loadRaters(ratingsfile);
    }

    private ArrayList<Rater> loadRaters(
        String filename
    ) {
